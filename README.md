...
3-1. the date when the account was opened, ie. older accounts are shorter, newer accounts are longer
3-2. the country where the account was opened, eg: Ireland uses IBAN, USA uses ABA routing transit numbers, Malaysia uses SWIFT code.
3-3. branch code/sort code
3.4. routing codes
